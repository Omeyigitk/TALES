...
export const CLASS_FEATURES: Record<string, Record<number, ClassFeature[]>> = {
    Barbarian: {
        ...
        6: [{ name: "Path Feature", desc_tr: "Seçtiğin Öfke Yolu'ndan yeni bir özellik kazanırsın." }],
        ...
        10: [{ name: "Path Feature", desc_tr: "Seçtiğin Öfke Yolu'ndan 10. seviye özelliği kazanırsın." }],
        ...
        14: [{ name: "Path Feature", desc_tr: "Seçtiğin Öfke Yolu'ndan nihai özellik kazanırsın." }],
    ...
    Fighter: {
        ...
        5: [{ name: "Extra Attack", desc_tr: "Saldırı aksiyonunda 2 saldırı yapabilirsin." }],
        7: [{ name: "Archetype Feature", desc_tr: "Savaşçı alt sınıfından yeni bir özellik kazanırsın." }],
        9: [{ name: "Indomitable", desc_tr: "Bir kurtarma atışını yeniden atabilirsin. Uzun dinlenmede yenilenir." }],
        10: [{ name: "Archetype Feature", desc_tr: "Savaşçı alt sınıfından yeni bir özellik kazanırsın." }],
        ...
        15: [{ name: "Archetype Feature", desc_tr: "Savaşçı alt sınıfından yeni bir özellik kazanırsın." }],
        ...
        18: [{ name: "Archetype Feature", desc_tr: "Savaşçı alt sınıfından nihai özellik kazanırsın." }],
    ...
    Wizard: {
        ...
        6: [{ name: "Tradition Feature", desc_tr: "Seçtiğin büyü okulundan yeni bir özellik kazanırsın." }],
        10: [{ name: "Tradition Feature", desc_tr: "Seçtiğin büyü okulundan yeni bir özellik kazanırsın." }],
        14: [{ name: "Tradition Feature", desc_tr: "Seçtiğin büyü okulundan nihai özellik kazanırsın." }],
    ...
    Rogue: {
        ...
        17: [{ name: "Archetype Feature", desc_tr: "Hırsız alt sınıfından nihai özellik kazanırsın." }],
    ...
    Paladin: {
        ...
        7: [{ name: "Oath Feature", desc_tr: "Paladin yemininize göre yeni bir özellik kazanırsın." }],
        ...
        15: [{ name: "Oath Feature", desc_tr: "Paladin yemininize göre yeni bir özellik kazanırsın." }],
    ...
    Ranger: {
        ...
        5: [{ name: "Extra Attack", desc_tr: "Saldırı aksiyonunda 2 saldırı yapabilirsin." }],
        7: [{ name: "Archetype Feature", desc_tr: "Seçtiğin alt sınıftan yeni bir özellik kazanırsın." }],
        ...
        11: [{ name: "Archetype Feature", desc_tr: "Seçtiğin alt sınıftan yeni bir özellik kazanırsın." }],
        14: [{ name: "Vanish", desc_tr: "Bonus aksiyon: Hide. Kaçamadığın sürece hiçbir zaman izlenemezsin." }],
        15: [{ name: "Archetype Feature", desc_tr: "Seçtiğin alt sınıftan nihai özellik kazanırsın." }],
    ...
    Monk: {
        ...
        5: [{ name: "Extra Attack", desc_tr: "Saldırı aksiyonunda 2 saldırı yapabilirsin." },
        { name: "Stunning Strike", desc_tr: "İisabetli vuruşta 1 Ki: CON save ya da hedef Stunned olur." }],
        6: [{ name: "Ki-Empowered Strikes", desc_tr: "Silahsız saldırılar büyülü hasar yapar." },
        { name: "Tradition Feature", desc_tr: "Seçtiğin manastır geleneğinden yeni bir özellik kazanırsın." }],
        ...
        11: [{ name: "Tradition Feature", desc_tr: "Seçtiğin manastır geleneğinden yeni bir özellik kazanırsın." }],
        ...
        17: [{ name: "Tradition Feature", desc_tr: "Seçtiğin manastır geleneğinden nihai özellik kazanırsın." }],
    ...
    Druid: {
        ...
        6: [{ name: "Circle Feature", desc_tr: "Seçtiğin druid çevresinden yeni bir özellik kazanırsın." }],
        10: [{ name: "Circle Feature", desc_tr: "Seçtiğin druid çevresinden yeni bir özellik kazanırsın." }],
        14: [{ name: "Circle Feature", desc_tr: "Seçtiğin druid çevresinden nihai özellik kazanırsın." }],
    ...
    Sorcerer: {
        ...
        6: [{ name: "Origin Feature", desc_tr: "Büyü kaynağınızdan yeni bir özellik kazanırsın." }],
        14: [{ name: "Origin Feature", desc_tr: "Büyü kaynağınızdan yeni bir özellik kazanırsın." }],
        18: [{ name: "Origin Feature", desc_tr: "Büyü kaynağınızdan nihai özellik kazanırsın." }],
    ...
    Artificer: {
        1: [{ name: "Magical Tinkering", desc_tr: "Küçük objelere büyüsel etkiler (ışık, ses, koku vb.) verirsin." },
        { name: "Spellcasting", desc_tr: "Artificer büyücülüğü. INT spellcasting ability." }],
        2: [{ name: "Infuse Item", desc_tr: "Eşyaları geçici sihirli eşyalara dönüştürebilirsin (Enhanced Weapon, Bag of Holding vb.)" }],
        3: [{ name: "Artificer Specialist", desc_tr: "Uzmanlık alanını seçersin (Alchemist, Artillerist, Battle Smith, Armorer)." },
        { name: "The Right Tool for the Job", desc_tr: "Büyüsel olarak ihtiyacın olan her türlü zanaat aracını oluşturabilirsin." }],
        5: [{ name: "Specialist Feature", desc_tr: "Seçtiğin uzmanlık alanından ilk özelliğini kazanırsın." }],
        6: [{ name: "Tool Expertise", desc_tr: "Yeterli olduğun tüm araçlarla yaptığın kontrollerde yeterlilik bonusun iki katına çıkar." }],
        7: [{ name: "Flash of Genius", desc_tr: "Senin veya 30 ft içindeki birinin kontrol/save atışına INT modini ekleyebilirsin." }],
        9: [{ name: "Specialist Feature", desc_tr: "Uzmanlık alanından yeni bir özellik kazanırsın." }],
        10: [{ name: "Magic Item Adept", desc_tr: "Aynı anda 4 sihirli eşyaya bağlanabilirsin (attunement). Eşya üretimi daha hızlı ve ucuz olur." }],
        11: [{ name: "Spell-Storing Item", desc_tr: "Bir silaha veya odağa Artificer büyüsü depolayabilirsin." }],
        14: [{ name: "Magic Item Savant", desc_tr: "Aynı anda 5 sihirli eşyaya bağlanabilirsin. Eşyaların sınıf/ırk kısıtlamalarını yoksayarsın." }],
        15: [{ name: "Specialist Feature", desc_tr: "Uzmanlık alanının en üst seviye özelliğini kazanırsın." }],
        18: [{ name: "Magic Item Master", desc_tr: "Aynı anda 6 sihirli eşyaya bağlanabilirsin." }],
        20: [{ name: "Soul of Artifice", desc_tr: "Bağlandığın her sihirli eşya başına kurtarma atışlarına +1 kazanırsın. 0 HP'ye düşersen bir infüzyonu bitirerek 1 HP ile kalabilirsin." }],
    },
};
